        ...
        <div>
            ...
            >
                ...
                <Grid item xs={12} sm={6} md={3}>
                    ...
                    <div>
                    <Button className="pb-5" variant="h6" gutterBottom> Payments </Button>
                    </div>

                    <div>
                    <Button className="pb-5" variant="h6" gutterBottom> Shipping </Button>
                    </div>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    ...
                    <div>
                    <Button className="pb-5" variant="h6" gutterBottom> Cancellation and Returns </Button>
                    </div>
                    ...
                    <div>
                    <Button className="pb-5" variant="h6" gutterBottom> Security </Button>
                    </div>
                ...
                <Grid className="pt-20  " item xs={12}>
                        <Typography variant="body2" component="p" align="center">
                            &copy; 2024 FlashFashionHub. All rights reserved.
                        </Typography>

                        <Typography variant="body2" component="p" align="center">
                            Made with love by FlashFashionHub Team.
                        </Typography>
